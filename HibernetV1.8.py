import socket, socks, threading, random, re, urllib.request, os.path
import logging
...
def choicedownproxy():
	choice4 = input("Do you want to download a fresh list of proxy? Answer 'y' to do it: ")
	if choice4 == "y":
		choicemirror1()
	else:
		proxylist()
...
def choicedownsocks():
	choice4 = input("Do you want to download a fresh list of socks? Answer 'y' to do it: ")
	if choice4 == "y":
		choicemirror2()
	else:
		proxylist()
