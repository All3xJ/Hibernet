...
def loop():
	...
	for x in range(threads): # con questa formula diciamo ai threads di attaccare.
		attack(x+1).start() # start() non fa altro che leggere nella classe  threading.Thread
                                    # cercando la funzione run(self), la quale serve per 
                                    # dare istruzioni ai threads.
